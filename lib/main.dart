          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                validator: (value) => value == null || value.isEmpty ? 'Please enter your major' : null,
                onSaved: (value) => _major = value,
              ),
              const SizedBox(height: 16.0),
              ColoredBox(color:   Colors.blue, child: const SizedBox(height: 2.0)),
              const SizedBox(height: 16.0),
              TextFormField(
                decoration: const InputDecoration(
                  labelText: 'Password',
